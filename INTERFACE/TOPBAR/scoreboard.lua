...
function ScoreBoard:draw()
    ...
    love.graphics.printf(self.mines.flagged.text, self.mines.flagged.font, self.mines.flagged.transform, 
                         self.mines.flagged.limit, self.mines.flagged.align)
    love.graphics.printf(self.mines.swept.text, self.mines.swept.font, self.mines.swept.transform, 
                         self.mines.swept.limit, self.mines.swept.align)
    love.graphics.printf(self.mines.missed.text, self.mines.missed.font, self.mines.missed.transform, 
    ...
    love.graphics.printf(self.gold.swept.text, self.gold.swept.font, self.gold.swept.transform, 
                         self.gold.swept.limit, self.gold.swept.align)
    love.graphics.printf(self.gold.missed.text, self.gold.missed.font, self.gold.missed.transform, 
    ...
    love.graphics.printf(self.squares.cleared.text, self.squares.cleared.font, self.squares.cleared.transform, 
                         self.squares.cleared.limit, self.squares.cleared.align)
    love.graphics.printf(self.squares.missed.text, self.squares.missed.font, self.squares.missed.transform, 
    ...
    love.graphics.printf(self.final.time.text, self.final.time.font, self.final.time.transform, 
                         self.final.time.limit, self.final.time.align)
    love.graphics.printf(self.final.explo.text, self.final.explo.font, self.final.explo.transform, 
                         self.final.explo.limit, self.final.explo.align)
    love.graphics.printf(self.final.final.text, self.final.final.font, self.final.final.transform, 
